...
AC_DEFUN([SELECT_MCU],
    [
        ...
        case "$with_mcu" in
            at32f4xx)  AC_DEFINE(HAVE_SELECT_MCU_AT32F4XX,  1, [select mcu at32f4xx]) ;;
            hc32l13x)  AC_DEFINE(HAVE_SELECT_MCU_HC32L13X,  1, [select mcu hc32l13x]) ;;
            hc32f003)  AC_DEFINE(HAVE_SELECT_MCU_HC32F003,  1, [select mcu hc32f003]) ;;
